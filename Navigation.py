...
class Navigation(CTkFrame):
    def __init__(self, parent: App, **kwargs):
        ...
        after_element: Dict[str, any] = {'pady': RIGHT_PADDING_ONLY, 'side': "bottom"}
        ...
        camera_sensitivity_slider.pack(*after_element)
        ...
        for shape_name, shape_class_reference in buttons:
